...
#年级全部班级的方差
st.write('所在班级方差')
toChart.toVarianceBar(stuName=title, courseName=add_selectbox)
...
#年级全部班级的方差
st.write('前150名方差')
toChart.toVarianceBar(stuName=title, courseName=add_selectbox, vip=True)
...
#年级前150名的总分图
st.write('年级前'+str(basicData.vipCount)+'名累计分数的折线图')
toChart.lineTotalScore(add_selectbox)
...
toChart.toChartTheCourse(add_selectbox, title)
